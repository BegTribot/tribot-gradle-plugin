package org.tribot.begtribot.gradle.plugin
...
internal fun getTribotDirectory(): File? {
    ...
    } else if (osName.contains("solaris") || osName.contains("linux") || osName.contains("sunos") || osName.contains("unix")) {
        directory = File(userHome, ".tribot" + File.separatorChar)
    } else if (osName.contains("mac")) {
        directory = File(
            userHome,
            "Library" + File.separatorChar + "Application Support" + File.separatorChar + "tribot"
        )
    } else {
        directory = File(userHome, "tribot" + File.separatorChar)
    }
